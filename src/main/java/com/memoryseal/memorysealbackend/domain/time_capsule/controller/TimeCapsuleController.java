...
public class TimeCapsuleController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "1. 지원하지 않는 파일 형식 \t\n 2. 업로드할 파일이 없음 \t\n 3. 제목 20자 초과",
                    ...
                    examples = {
                            @ExampleObject(name = "지원하지 않는 파일 형식", value = "{\"status\": \"400\", \"error\": \"INVALID_FILE_FORMAT\", \"message\": \"지원하지 않는 파일 형식입니다.\", \"path\": \"/time-capsules/create\"}"),
                            @ExampleObject(name = "업로드할 파일이 없음", value = "{\"status\": \"400\", \"error\": \"EMPTY_FILE\", \"message\": \"업로드할 파일이 없습니다.\", \"path\": \"/time-capsules/create\"}"),
                            @ExampleObject(name = "제목 20자 초과", value = "{\"status\": \"400\", \"error\": \"INVALID_PARAMETER\", \"message\": \"파라미터 값을 확인해 주세요\", \"path\": \"/time-capsules/create\"}")
                    })),
